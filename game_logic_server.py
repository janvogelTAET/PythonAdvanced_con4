...
"""
This program (it's not a class) implements the REST endpoints for a game logic.
These Endpoints are used in GameLogicClient.
"""
...
if __name__ == "__main__":
    ...
    def get_board():
        ...
        #returns the board from the local GameLogic object to the caller
        # print("server: GET /api/board")
                ...
                schema:
                    ...
                    properties:
                        state:
                            ...
                            example: 1
        """
        # print("server: GET /api/state")

        # YOUR CODE HERE

        # NOTE: Enum is not 'serializable', that is, it can't be 'jsonified'. but int can!
    ...
    # run the server
    print("GameLogicServer start")
    app.run(host="0.0.0.0", debug=True) # run on any and all available IP addresses
